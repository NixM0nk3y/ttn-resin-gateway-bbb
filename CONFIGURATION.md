...
# Logal debugging
```
docker run --device /dev/ttyAMA0:/dev/ttyAMA0 --privileged -e GW_TYPE="imst-ic880a-spi" -e GW_DESCRIPTION="test gateway" -e GW_CONTACT_EMAIL="" -e GW_ID="" -e GW_KEY="" newforwarder
